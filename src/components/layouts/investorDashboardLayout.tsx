...
import styles from "../../admin_components/layouts/dashboardLayout/style.module.scss";
...
import InvestorSidebar from "../clientOnboarding/sections/investorSidebar";

const InvestorDashboardLayout: React.FC<IProps> = ({
  children,
  isBgExist,
  title,
  backBtn,
            ...
            {!noHeader && (
              <div className="flex justify-between items-center mb-5">
                ...
                <div className="flex items-center">
                  {pathname.includes("clientOnboarding/subscription") ? (
