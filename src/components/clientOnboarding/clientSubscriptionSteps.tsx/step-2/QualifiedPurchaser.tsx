      ...
      <div>
        <div
          className={`p-4 mb-4 border ${
            +data?.qualified_purchaser_status === 1 ? 'border-[#3190E6] bg-[#3190E60F]' : 'bg-[#FCFAFA] border-[#DCE1E6]'
          }`}
        >
          <Radio
        ...
        <div
          className={`p-4 mb-4 border w-full ${
            +data?.qualified_purchaser_status === 2 ? 'border-[#3190E6] bg-[#3190E60F]' : 'bg-[#FCFAFA] border-[#DCE1E6]'
          }`}
        >
          <Radio
            name="qualified_purchaser_status"
        ...
        <div
          className={`p-4 mb-4 border w-full ${
            +data?.qualified_purchaser_status === 3 ? 'border-[#3190E6] bg-[#3190E60F]' : 'bg-[#FCFAFA] border-[#DCE1E6]'
          }`}
        >
          <Radio
            name="qualified_purchaser_status"
